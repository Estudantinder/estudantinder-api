...
public class Resource {
    ...
    @Inject
    Controller showUserMatchsController;
    ...
    public Response showUserMatchs(@Context SecurityContext ctx) throws Exception {
        return showUserMatchsController.handle(jwt);
    }
