...
INSERT INTO preferences (id, gender, shift, school_year , course_id) VALUES (nextval('hibernate_sequence'), 'Masculino', null, 0, null);
INSERT INTO preferences (id, gender, shift, school_year , course_id) VALUES (nextval('hibernate_sequence'), 'Feminino', 'Manhã', 0, null);
INSERT INTO preferences (id, gender, shift, school_year , course_id) VALUES (nextval('hibernate_sequence'), 'Feminino', 'Tarde', 3, null);
INSERT INTO preferences (id, gender, shift, school_year , course_id) VALUES (nextval('hibernate_sequence'), 'Masculino', 'Manhã', 3, 8);


INSERT INTO student (id, bio, birth_date, email, subjects, gender, name, password, photos, shift, school_year, contacts_id, course_id, preferences_id) VALUES 
